...
- - -
## jilebi-0.1.0 - 2026-09-08
#### Bug Fixes
- **(jilebi)** send user agent in all mcp jilebi requests - (f9c83f4) - datron
- context remove should space things correctly - (f8ec5e1) - datron
- Correctly setup plugins that are not in the base plugin dir - (f325348) - datron
- add list remote plugins cli command - (a48ff90) - datron
...
- read plugin logs - (2d7dda4) - datron
...
#### Features
- add support for remote MCP servers (#2) - (9558d79) - Datron
- update to mcp spec 2026-11-25, rmcp v1.7.0 - (ecc423f) - datron
- add installation and uninstallation scripts - (2ce3ef9) - datron
...
- added new APIs for plugins and releases - (d0e43bf) - datron
- show plugin versions in list command - (3c19f46) - datron
- clear logs from jilebi cli - (8acccf1) - datron
- add plugin version support - (e10b53c) - datron
...
- **(version)** 0.6.1 [skip ci] - (85d4cfe) - Semver bot
- **(version)** 0.6.0 [skip ci] - (feb03e0) - Semver bot
...
- move domain to mcp.jilebi.ai - (80b82c5) - datron
- updated js-types and priorities - (aa7beb1) - datron
...
#### Refactoring
- organize DB code - (a12480c) - datron
