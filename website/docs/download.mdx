...
<div className={styles.downloadGrid}>
  <div className={styles.downloadColumn}>
    ...
    <div className={styles.columnBody}>
      <a href="/downloads/jilebi-windows-x64.exe" className="button button--outline button--primary button--lg">
        x86_64
      </a>
    </div>
  </div>
  ...
  <div className={styles.downloadColumn}>
    ...
    <div className={styles.columnBody}>
      <a href="/downloads/jilebi-linux-x64.tar.gz" className="button button--outline button--primary button--lg">
        x86_64
      </a>
    </div>
  </div>
  ...
  <div className={styles.downloadColumn}>
    ...
    <div className={styles.columnBody}>
      <a href="/downloads/jilebi-macos-arm64.dmg" className="button button--outline button--primary button--lg">
        Apple Silicon
      </a>
      <a href="/downloads/jilebi-macos-x64.dmg" className="button button--outline button--primary button--lg">
        Intel
      </a>
    </div>
  </div>
...
6. Install a few extremely useful plugins, I recommend memory and sequential-thinking. You can install them with the command
  ```
  	.\jilebi plugins add memory
  	.\jilebi plugins add sequential-thinking
  ```
  You can find more plugins to install [here](https://github.com/datron/jilebi-plugins)
7. run jilebi using the command `./jilebi stdio`. This starts the MCP server. You won't see anything yet, we need to hook it up to a host
